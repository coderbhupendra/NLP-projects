...
def get_layer(name):
    #layers here is a dictionary , so on passing key "name"="lstm" , it will give me value 
    #here (param_init_lstm, lstm_layer) are two functions which are returing some values
    #line no 211 , layers = {'lstm': (param_init_lstm, lstm_layer)}
